...
def get_args():
    ...
    parser.add_argument('-o', '--order', choices=["list", "unit"], default="list", help='choose "list" to sort by the listed item price (5 EUR/1 bag(30g)), or unit price to sort by the per per unit (ex: 10 EUR/kg).\nDefault is listed price')
